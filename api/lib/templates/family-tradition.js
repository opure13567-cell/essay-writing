...
export function buildPrompt(data) {
  ...
  const optionLabels = {
    ...
    no_artifacts: '家中未刻意保留实物材料，但家风在言传身教中传承',
    unsure_artifacts: '家中可能有材料但需进一步整理',

    detailed: '家族中有清晰的转折性故事，细节丰富',
    vague: '家族故事有大概印象，细节待补充和完善',
    no_story: '家族中虽无戏剧性故事，但家风在日常生活的点滴中潜移默化',
    unsure_story: '家族故事需进一步访谈和挖掘',
...
### 重要：标题必须AI自创
- 不要使用"${title}"这个标题！
- 根据文章的具体内容（核心家训方向、家族故事），自创一个独一无二的标题
- 标题风格参考：用比喻、化用古诗词、提炼家训关键词，带副标题
- 例如："守得云开见月明——我的家风家训调查报告""一粥一饭当思来处——记我家的勤俭之风""父亲的工具箱里装着什么——我的家风调查报告"
- 保证每次生成的标题都不一样，要让人一看就觉得是真人起的
...
4. 每段开头要变换方式：有的用"说到…"，有的用"其实…"，有的直接进入内容，不要总用一样的开头
5. 适当加入"说实话""我觉得""真的""挺…的"等口语表达，强化真人感
6. 偶尔加入一个不完美但合理的表达（如轻微的重复、口语化转折、不太准确的用词）
7. 不要用分点列举，用自然段落
8. 在正文中恰当引用一两处中华传统文化经典作为理论支撑，但引用要自然融入，不要显得刻意
9. 关键：避免使用以下AI高频词汇和句式——"不仅…更…""随着…的发展""值得注意的是""毋庸置疑""综上所述""首先其次最后"

## 重要提醒
- 这是一份调查报告，不是小说，要有调查感和真实感
- 在提到访谈内容时，用"父亲回忆说""母亲反复强调"等表述
- 附录的访谈提纲请列出5-8个核心访谈问题
- 不要让文章结构过于清晰——真人大学生的报告会有一些散乱和跳跃

## 防AI识别与防辅导员识破规则（严格遵守）
- 不要在文中提到作者的年龄、出生年份
- 不要写"作为一名大一/大二/X年级学生"等明确身份表述
- 不要编造具体的家庭地址、具体村镇名或小区名
- 不要用"回想起X年前""在我X岁那年"等暴露年龄的表述
- 不要编造访谈的具体日期
- 家族成员用"父亲""母亲""祖父"等泛称，不要出现真实姓名
- 保持自然的调查报告风格，像真人学生采访调研后写的，不要过于完美`
}
